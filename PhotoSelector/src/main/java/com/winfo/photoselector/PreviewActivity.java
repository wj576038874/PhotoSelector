...
public class PreviewActivity extends AppCompatActivity {
    ...
    public static void openActivity(Activity activity, ArrayList<Image> images,
                                    ...
                                    int maxSelectCount, int position, int topBarColor, int bottomBarColor, int statusBarColor) {
        tempImages = images;
        ...
        intent.putExtra(PhotoSelector.EXTRA_TOOLBARCOLOR, topBarColor);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStatusBarColor(intent.getIntExtra(PhotoSelector.EXTRA_STATUSBARCOLOR, R.color.blue));
        initView();
        setToolBarColor(intent.getIntExtra(PhotoSelector.EXTRA_TOOLBARCOLOR, R.color.blue));
        setBottomBarColor(intent.getIntExtra(PhotoSelector.EXTRA_BOTTOMBARCOLOR, R.color.blue));
        initListener();
        initViewPager();

        tvIndicator.setText(1 + "/" + mImages.size());
        changeSelect(mImages.get(0));
        vpImage.setCurrentItem(intent.getIntExtra(PhotoSelector.EXTRA_POSITION, 0));
    }
    ...
    private void setToolBarColor(int color) {
        rlTopBar.setBackgroundColor(ContextCompat.getColor(this, color));
    }
    ...
    private void setBottomBarColor(int color) {
        rlBottomBar.setBackgroundColor(ContextCompat.getColor(this, color));
    }
